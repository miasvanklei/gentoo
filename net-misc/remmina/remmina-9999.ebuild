...
MY_P="${PN^}-v${PV}"
inherit cmake flag-o-matic git-r3 python-single-r1 xdg

DESCRIPTION="A GTK+ RDP, SPICE, VNC and SSH client"
HOMEPAGE="https://remmina.org/"
EGIT_REPO_URI="https://gitlab.com/Remmina/Remmina.git"
...
src_prepare() {
	...
	# workaround for casting (const char*) to (void*)
	sed -i '/incompatible-pointer-types/s/^/#/g' CMakeLists.txt || die
